            ...
            >
                <div class="makeStyles-paper-1">
                    ...
                    <div className="publishOptions">
                        ...
                        <div class="right" >
                            <PhotoIcon class="Icon roomIcon" onClick={uploadFileWithClick}/>
                            <SupervisorAccountIcon class="Icon roomIcon"/>
        <EmojiEmotionsIcon class="Icon roomIcon"/>
                           <LoyaltyIcon class="Icon roomIcon"/>
            ...
            <div class="imageupload__container">
                ...
                <div class="options">
                    ...
                    <VideoCallIcon class="liveVideoIcon"/>
                        <h2>Live video</h2>
                    </div>
                    <div class="photo" onClick={handleClickOpen('body')}>
                        
                        <PhotoIcon class="photoIcon" />
                        <h2>Photo/Video</h2>
                    </div>
                    <div class="feeling" onClick={handleClickOpen('body')}>
                        <i class="feelingIcon" />
                        <EmojiEmotionsIcon class="feelingIcon" />
